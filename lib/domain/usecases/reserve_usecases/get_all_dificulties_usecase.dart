...
class GetAllDifficultyUseCase
    implements UseCase<Either<Failure, List<DifficultyEntity>>, NoParams> {
  final DifficultyRepository repository;
  GetAllDifficultyUseCase(this.repository);

  @override
  Future<Either<Failure, List<DifficultyEntity>>> call(NoParams params) async {
